    ...
    return (
        <>
            <div className="flex items-center justify-between px-8 py-5">
                ...
                <div className="w-auto">
                    <div className="flex flex-wrap items-center">
                        <div className="w-auto hidden lg:block cursor-auto">
                    ...
                    <div className="flex flex-wrap justify-between h-full">
                        ...
                        <div className="flex flex-col justify-end w-full">
                            <div className="flex flex-wrap">
                                ...
                                <div className="w-full">
                                    <button className="group relative p-0.5 font-heading block w-full text-lg text-gray-900 font-medium bg-gradient-cyan overflow-hidden rounded-10 cursor-pointer">
